...
public class CustomCh34xSerialDriver implements UsbSerialDriver {

    private static final String TAG = CustomCh34xSerialDriver.class.getSimpleName();
    ...
    public CustomCh34xSerialDriver(UsbDevice device) {
        mDevice = device;
    ...
    public class Ch340SerialPort extends CommonUsbSerialPort {
        ...
        public UsbSerialDriver getDriver() {
            return CustomCh34xSerialDriver.this;
        }
        ...
        private void initialize() throws IOException {
            checkState("init #1", 0x5f, 0, new int[]{-1 /* 0x27, 0x30 */, -1});
